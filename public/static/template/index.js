...
data.forEach(async payload => {
  if (debug) {
    ...
    // Publish asset data to marketplace
    await publish(payload); // your asset data goes here. Payload is any content in JSON format
  }
});

// EXAMPLE 2: request data from server or asset
