...
export default class ExampleAssets extends React.Component {
      ...
      <AssetsWrapper id={id || null}>
        <OuterWrapper>
          <InnerWrapper>
            ...
            <Assets>
              <AssetsListTitle>Example Assets to utilize:</AssetsListTitle>
              <AssetsListWrapper>
                {assets.map(({ link, text }) => (
...
const AssetsListTitle = styled.p`
  font-size: 22px;
  font-weight: normal;
  font-style: normal;
  font-stretch: normal;
